...
func resourceAwsCredentialsConfigutationCreate(d *schema.ResourceData, m interface{}) error {
	return nil
}

func resourceAwsCredentialsConfigutationRead(d *schema.ResourceData, m interface{}) error {
	return nil
}

func resourceAwsCredentialsConfigutationUpdate(d *schema.ResourceData, m interface{}) error {
	return nil
}

func resourceAwsCredentialsConfigutationtDelete(d *schema.ResourceData, m interface{}) error {
	return nil
}

func resourceAwsCredentialsConfigutationExists(d *schema.ResourceData, m interface{}) (bool, error) {
	return true,nil
}
